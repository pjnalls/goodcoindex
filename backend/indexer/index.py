"""
Create a search index for a given website.
"""

from typing import Iterable
from urllib.parse import unquote

from backend.tinysearchengine.indexer import TokenizedDocument
...
def tokenize_document(url, title_cleaned, extract, score):
    ...
    tokens = get_index_tokens(title_tokens) | get_index_tokens(
        url_tokens) | get_index_tokens(extract_tokens)
